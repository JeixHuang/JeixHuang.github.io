...
<section class="weekly-hero-memo">
  ...
  <div class="weekly-keyword-grid"><div class="weekly-keyword-card">
              ...
              <em>路径</em>
              <p>flow / ODE 轨迹决定步数弹性、稳定性和推理成本。</p>
            </div>
<div class="weekly-keyword-card">
              <span>02</span>
              <strong>tokenizer-VAE</strong>
              <em>表征</em>
              <p>压缩层开始成为图像生成质量和可编辑性的基础设施。</p>
            </div>
<div class="weekly-keyword-card">
              <span>03</span>
              <strong>video distillation</strong>
              <em>时序</em>
              <p>实时视频的关键变量是 latency、history distribution 和 rollout 粒度。</p>
            </div>
<div class="weekly-keyword-card">
              <span>04</span>
              <strong>3D correspondence</strong>
              <em>几何约束</em>
              <p>image-to-3D 与 tracking 都在回到像素、空间和运动的一致性。</p>
            </div></div>
  <div class="weekly-hero-meta">
    <span>2026.5.11 - 5.17</span>
    <span>20 papers</span>
  </div>
</section>
...
<div class="weekly-directory-row" id="a17">
              ...
              <b>方法</b>
              <em>从 frozen vision encoder 的中间层和最后层同时取特征，再做 multi-layer representation fusion。</em>
            </span><span class="weekly-directory-tldr-line">
              <b>效果</b>
